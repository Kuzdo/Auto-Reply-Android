...
class AutoStartHelper private constructor() {
    ...
    private fun showAlert(context: Context, onClickListener: DialogInterface.OnClickListener) {
        ...
        val bundle = Bundle()
        bundle.putString(
            pro.kuzdowicz.autoreply.constants.Constants.PERMISSION_DIALOG_TITLE,
            context.getString(R.string.auto_start_permission_dialog_title)
        )
        bundle.putString(
            pro.kuzdowicz.autoreply.constants.Constants.PERMISSION_DIALOG_MSG,
            """
    ...
    companion object {
        @JvmStatic
        val instance: pro.kuzdowicz.autoreply.helpers.AutoStartHelper
            get() = pro.kuzdowicz.autoreply.helpers.AutoStartHelper()
    }
}
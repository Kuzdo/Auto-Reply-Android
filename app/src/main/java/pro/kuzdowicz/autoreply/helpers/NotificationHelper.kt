package pro.kuzdowicz.autoreply.helpers
...
import pro.kuzdowicz.autoreply.ui.activity.notification.NotificationIntentActivity
import android.app.PendingIntent
import android.content.Context
import pro.kuzdowicz.autoreply.R
import androidx.core.app.NotificationCompat
import pro.kuzdowicz.autoreply.BuildConfig
...
class NotificationHelper private constructor(private val appContext: Context) {
    private fun init() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val notificationChannel = NotificationChannel(
                pro.kuzdowicz.autoreply.constants.Constants.NOTIFICATION_CHANNEL_ID,
                pro.kuzdowicz.autoreply.constants.Constants.NOTIFICATION_CHANNEL_NAME,
                NotificationManager.IMPORTANCE_DEFAULT
            )
            notificationManager!!.createNotificationChannel(notificationChannel)
        }
        for ((_, packageName) in pro.kuzdowicz.autoreply.constants.Constants.SUPPORTED_APPS) {
            try {
    ...
    fun sendNotification(title: String, message: String?, packageName: String) {
        var title = title
        for ((name, packageName1) in pro.kuzdowicz.autoreply.constants.Constants.SUPPORTED_APPS) {
        ...
        val notificationBuilder = NotificationCompat.Builder(
            appContext, pro.kuzdowicz.autoreply.constants.Constants.NOTIFICATION_CHANNEL_ID
        )
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            for ((_, packageName1) in pro.kuzdowicz.autoreply.constants.Constants.SUPPORTED_APPS) {
                try {

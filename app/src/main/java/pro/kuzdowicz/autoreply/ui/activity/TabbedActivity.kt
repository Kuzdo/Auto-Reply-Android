package pro.kuzdowicz.autoreply.ui.activity
...
import pro.kuzdowicz.autoreply.databinding.ActivityTabbedBinding
import pro.kuzdowicz.autoreply.helpers.AlertDialogHelper
import pro.kuzdowicz.autoreply.ui.activity.main.SectionsPagerAdapter
...
class TabbedActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.help_menu -> {
                pro.kuzdowicz.autoreply.helpers.AlertDialogHelper.showDialog(
                        this,
                        "Help",

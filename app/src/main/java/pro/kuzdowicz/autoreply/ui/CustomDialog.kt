package pro.kuzdowicz.autoreply.ui
        ...
        if (bundle != null) {
            ...
            if (type != null && type == "AutoStart") {
                materialAlertDialogBuilder = MaterialAlertDialogBuilder(mContext)
                    .setTitle(bundle.getString(pro.kuzdowicz.autoreply.constants.Constants.PERMISSION_DIALOG_TITLE))
                    .setMessage(bundle.getString(pro.kuzdowicz.autoreply.constants.Constants.PERMISSION_DIALOG_MSG))
            ...
            } else if (bundle.containsKey(pro.kuzdowicz.autoreply.constants.Constants.PERMISSION_DIALOG_DENIED)
                && bundle.getBoolean(pro.kuzdowicz.autoreply.constants.Constants.PERMISSION_DIALOG_DENIED)
            ) {
                materialAlertDialogBuilder = MaterialAlertDialogBuilder(mContext)
                    .setTitle(bundle.getString(pro.kuzdowicz.autoreply.constants.Constants.PERMISSION_DIALOG_DENIED_TITLE))
                    .setIcon(mContext.resources.getDrawable(R.drawable.ic_alert))
                    .setMessage(bundle.getString(pro.kuzdowicz.autoreply.constants.Constants.PERMISSION_DIALOG_DENIED_MSG))
                materialAlertDialogBuilder

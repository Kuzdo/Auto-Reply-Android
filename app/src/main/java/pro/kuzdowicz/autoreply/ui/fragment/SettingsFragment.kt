...
import pro.kuzdowicz.autoreply.helpers.AutoStartHelper.Companion.instance
...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    private fun showPermissionDeniedDialog() {
        ...
        customDialog.showDialog(bundle, null) { _: DialogInterface?, which: Int ->
            if (which == -2) {
                // Decline
                Toast.makeText(mActivity, pro.kuzdowicz.autoreply.constants.Constants.PERMISSION_DENIED, Toast.LENGTH_LONG).show()
            } else {
                // Accept
                requestNotificationListenerPermission()
            }
